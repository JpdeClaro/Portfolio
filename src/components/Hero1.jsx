...
const Hero = ({ darkMode, toggleDarkMode }) => {
  ...
  return (
    <div className=" lg:bg-none lg:dark:bg-none bg-bgImgLight lg:dark:bg-[none] dark:bg-bgImgDark bg-no-repeat bg-fixed pt-[60px] xl:mb-[300px]  md:px-[66px] px-8 pb-[80px] flex flex-wrap justify-center ">
      ...
      >
        <img
          className="relative before:absolute left-0
          xl:w-[259px] xl:h-[259px] lg:w-[200px] lg:h-[200px]  rounded-full md:w-[230px] w-[150px]"
          src={ProfilePic}
          alt="Profile Picture"
        />
      </div>
